...
python3 /uscms_data/d3/yzhong/CMSSW_14_1_0_pre4/src/flashggFinalFit/Datacard/makeYields.py --cat cat1 --procs auto --ext test0421 --mass 125 --inputWSDirMap 2022=/uscms/home/yzhong/nobackup/2223_variations/ws_GG2HH/ --sigModelWSDir ./Models/signal --sigModelExt packaged --bkgModelWSDir ./Models/background --bkgModelExt multipdf  --skipCOWCorr --systWeightScheme accEff --doSystematics
