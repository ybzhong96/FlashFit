...
python3 /uscms_data/d3/yzhong/CMSSW_14_1_0_pre4/src/flashggFinalFit/Datacard/makeYields.py --cat cat0 --procs auto --ext v3_0703 --mass 125 --inputWSDirMap 2223=/uscms/home/yzhong/nobackup/2223_v3_0701/ws_test/ --sigModelWSDir ./Models/signal --sigModelExt packaged --bkgModelWSDir ./Models/background --bkgModelExt multipdf  --skipCOWCorr --systWeightScheme accEff --doSystematics
