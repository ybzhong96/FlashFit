...
python3 /eos/home-b/bdanzi/EarlyRun3HHbbgg/2D/CMSSW_14_1_0_pre4/src/flashggFinalFit_fullexp/CMSSW_14_1_0_pre4/src/flashggFinalFit/Signal/scripts/calcPhotonSyst.py --xvar mass --cat cat4 --procs GGHH_kl-1p00_kt-1p00_c2-0p00 --ext bbgg_2022+2023 --inputWSDir /eos/home-b/bdanzi/EarlyRun3HHbbgg/2D/CMSSW_14_1_0_pre4/src/flashggFinalFit_fullexp/CMSSW_14_1_0_pre4/src/flashggFinalFit/Trees2WS/inputs/bbgg/ws_GGHH_kl-1p00_kt-1p00_c2-0p00 --scales 'FNUF,Material,ScaleEB2GIJazZ,ScaleEE2GIJazZ,jecsyst' --scalesCorr '' --scalesGlobal '' --smears 'Smearing2GIJazZ,jersyst' --obsType mgg 
