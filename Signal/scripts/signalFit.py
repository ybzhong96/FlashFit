...
if opt.skipZeroes:
  ...
  WSFileName = glob.glob("%s/*_output*M%s*%s.root"%(opt.inputWSDir,MHNominal,opt.proc))[0]
...
if(datasetRVForFit[MHNominal].sumEntries() < 0. ):
