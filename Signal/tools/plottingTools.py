...
def plotPdfComponents(ssf,_outdir='./',_extension='',_proc='',_cat=''):
  ...
  hists['final'].GetXaxis().SetTitleSize(0.045)
  #hists['final'].GetXaxis().SetTitleOffset(1.0)

  hists['final'].GetYaxis().SetTitle("Events / 1.333 GeV")
  hists['final'].GetXaxis().SetTitleSize(0.045)
  ...
  hists['data'].SetTitle("")
  hists['data'].GetXaxis().SetTitle("m_{#gamma#gamma} [GeV]")
  hists['data'].GetXaxis().SetTitleSize(0.045)
 # hists['data'].GetXaxis().SetTitleOffset(1.0)
  hists['data'].SetMinimum(0)
  #hists['data'].GetXaxis().SetRangeUser(115,140)
  hists['data'].GetXaxis().SetRangeUser(100,150)
  hists['data'].GetYaxis().SetTitle("Events / 1.333 GeV")
  hists['data'].GetYaxis().SetTitleSize(0.045)
  hists['data'].Scale(float(ssf.nBins)/1600)
  hists['data'].SetMarkerStyle(20)
  hists['data'].SetMarkerColor(1)
  hists['data'].SetLineColor(1)
  ...
  #leg.AddEntry(hists['data'],"Simulation","ep")
  leg.AddEntry(hists['data'],"(%s, %s)"%(_proc,_cat),"ep")
 ...
 # lat.DrawLatex(0.1,0.92,"#bf{CMS} #it{Simulation}")
  lat.DrawLatex(0.9,0.91,"61.9 fb^{-1} (13.6 TeV)")
  ...
  lat1.DrawLatex(0.15,0.91,"#bf{CMS} #it{Simulation}")
 # lat1.DrawLatex(0.45,0.92,"#chi^{2}/n(dof) = %.4f"%(ssf.getChi2()/ssf.Ndof))
...
def plotInterpolation(_finalModel,_outdir='./',_massPoints='120,121,122,123,124,125,126,127,128,129,130'):
 ...
 # haxes.GetYaxis().SetTitle("Events / 1.333 GeV")
