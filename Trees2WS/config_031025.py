...
trees2wsCfg = {
  ...
  'mainVars':["CMS_hgg_mass","weight","weight_*"], # Var for the nominal RooDataSets
  ...
  'systematics':["EBScale","EEScale","Smearing", "JEC22", "JEC23", "JER22", "JER23", "FNUF", "Material"], #"LHEScale", "LHEPdf"],
